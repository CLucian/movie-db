...
import { isGenre, isCategory } from "../utils/helpers";
...
class App extends React.Component {
  ...
  handleCategory = (category) => {
    this.setState({ pageNum: 1, searchTerm: "" }, () =>
        ...
        {this.state.movie === null ? (
          <div>
            ...
            <MovieList
              ...
              setMovieInfo={this.setMovieInfo}
              similarMovies={this.state.similarMovies}
              setSimilarMovieInfo={this.setSimilarMovieInfo}
            />
          </div>
        ) : (
          <MovieInfo
